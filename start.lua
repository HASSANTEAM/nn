...
Sudos = {sudoid,1823884242,1551685033}
Sudo_Id = 1823884242
function Bot(msg)  
local idbot = false  
...
if text == "/start" then 
local bl = '*◾أهلا بك في صانع بوتات الحماية 👋🏻 ،\n\n◽البوت مقدم من قناة »* [. 𝖲𝗈𝗎𝗋𝖼𝖾 Hassan TeAm >](t.me/almohajrina_walansar7) \n\n*◾يمكنك الان صنع بوت واحد فقط من صانع البوتات\n\n     عليك استخدام اوامر التحكم اسفل وبدء الانشاء🔻\n⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯*\n[⚙️꒐ Gruop The Suport Maker .](https://t.me/almohajrina_walansar7)'
...
- تم انشاء الصانع مقدم من قناة ( @almohajrina_walansar ) مجاناً 
...
*⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯ ⎯
- قناة شروحات السورس : @almohajrina_walansar .
- بوت تواصل دعم السورس : @almohajrina_walansar .*
